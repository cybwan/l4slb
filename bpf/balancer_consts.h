...
// position where flomesh lb would register itself in prog array
// for recirculation
...
// For now, we are only collecting the data in flomesh lb stats but not
// dropping them.
 ...
 *
 * FLOMESHLB_INTROSPECTION - flomesh lb will start to perfpipe packet's header which
